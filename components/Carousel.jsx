export function Carousel(){
  return(
    <div className="carousel w-full md:h-[85vh] sm:h-[50vh]">
      ...
      <div className="hero items-left" style={{backgroundImage: 'url(https://daisyui.com/images/stock/photo-1507358522600-9f71e620c44e.jpg)'}}>
      <div className="hero-overlay bg-opacity-60"></div>
      <div className="text-left text-neutral-content">
        <div>
          <div className="text-left ">

            <h1 className="mb-5 text-[72px] font-black">Summer 
  Value Pack</h1>
            <p className="mb-5"></p>
        ...
        <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
          <a href="#slide4" className="btn btn-cirle bg-transparent">❮</a> 
